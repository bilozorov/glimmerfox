...
def save_conversation(conversation_id, question, answer_data, course, timestamp=None, localhost=False):
...
def save_feedback(conversation_id, feedback, timestamp=None, localhost=False):
    if timestamp is None:
        timestamp = datetime.now(tz)
